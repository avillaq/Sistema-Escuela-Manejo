...
import { administradoresService } from '@/service/apiService';
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card className="p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-primary-700">Total Administradores</p>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-success-700">Administradores Activos</p>
        ...
        <Card className="p-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-danger-700">Administradores Inactivos</p>
